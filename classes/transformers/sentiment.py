...
class SentimentModel(object): 
	...
	SENTIMENT_MODEL = pickle.load(open('/var/www/sandbox/ben/opinion-mining/modeling/results/final_models/senti_pred.p', 'rb'))
...
class OpinionModel(object):
	...
	OPINION_MODEL = pickle.load(open('/var/www/sandbox/ben/opinion-mining/modeling/results/final_models/opin_pred.p', 'rb'))
